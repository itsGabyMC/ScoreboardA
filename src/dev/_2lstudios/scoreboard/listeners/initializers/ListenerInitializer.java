...
public class ListenerInitializer {
    public ListenerInitializer(final Plugin plugin, final NametagUpdater nametagUpdater,
            final SidebarUpdater sidebarUpdater, final TabUpdater tabUpdater, final MainManager essentialsManager) {
        ...
        pluginManager.registerEvents(
                new PlayerJoinListener(essentialsManager, nametagUpdater, sidebarUpdater, tabUpdater, variableManager),
                plugin);
